inputfile = open('input7part2.txt','r')
'''
...
for part2 we went into the input file
and changed the line where wire b initially defiend
and set it to 956, the answer to part 1
'''
wires = {}
def dorules(rules):
